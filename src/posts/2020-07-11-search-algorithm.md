...
![在搜索引擎上搜索 post punk bands 1980s 的搜索结果](../img/duckduckgo-post-punk-bands.png)
...
![一列算法的清单，包括 BB2, BM25, DFR_BM25, DLH, DLH13 等](../img/revalence-evaluating-algorithms.png)
...
![搜索引擎展示了 List of post-punk bands 的 Wiki 条目，其中 post-punk bands, Post-punk 等词被高亮显示出来了](../img/duckduckgo-post-punk-hightlight.png)

当文档中的关键词比较分散的时候，我们也许需要提供多个片段才能更好地展示信息。

![搜索引擎展示了一个 postpunkprof.com 的页面，其中的 1980s, post-punk 等关键词分散地分布在网页中](../img/duckduckgo-post-punk-separate-hightlight.png)
...
![当搜索 pank band 时，搜索引擎会提示「你是否要找的是 punk band」](../img/duckduckgo-spell-check.png)
